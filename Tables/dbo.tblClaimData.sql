...
GO
ALTER TABLE [dbo].[tblClaimData] ADD CONSTRAINT [PK_tblClaimData] PRIMARY KEY CLUSTERED  ([ClaimData_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblClaimDataICD9] ON [dbo].[tblClaimData] ([DiagnosisCode]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_ClaimDataPK_Cols] ON [dbo].[tblClaimData] ([DOS_Thru]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblClaimDataMember] ON [dbo].[tblClaimData] ([Member_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblClaimDataProvider] ON [dbo].[tblClaimData] ([ProviderMaster_PK]) ON [PRIMARY]
GO
