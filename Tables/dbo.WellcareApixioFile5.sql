CREATE TABLE [dbo].[WellcareApixioFile5]
(
...
[ReceivedDate] [datetime] NULL CONSTRAINT [DF_WellcareApixioFile5_ReceivedDate] DEFAULT (getdate()),
...
[IsProcessed] [bit] NULL CONSTRAINT [DF_WellcareApixioFile5_IsProcessed] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[WellcareApixioFile5] ADD CONSTRAINT [PK_WellcareApixioFile5] PRIMARY KEY CLUSTERED  ([WellcareApixioFileID]) ON [PRIMARY]
GO
