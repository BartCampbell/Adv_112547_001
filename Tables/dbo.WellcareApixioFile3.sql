CREATE TABLE [dbo].[WellcareApixioFile3]
(
...
[ReceivedDate] [datetime] NULL CONSTRAINT [DF_WellcareApixioFile3_ReceivedDate] DEFAULT (getdate()),
...
[IsProcessed] [bit] NULL CONSTRAINT [DF_WellcareApixioFile3_IsProcessed] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[WellcareApixioFile3] ADD CONSTRAINT [PK_WellcareApixioFile3] PRIMARY KEY CLUSTERED  ([WellcareApixioFileID]) ON [PRIMARY]
GO
