CREATE TABLE [dbo].[WellcareApixioFile4]
(
...
[ReceivedDate] [datetime] NULL CONSTRAINT [DF_WellcareApixioFile4_ReceivedDate] DEFAULT (getdate()),
...
[IsProcessed] [bit] NULL CONSTRAINT [DF_WellcareApixioFile4_IsProcessed] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[WellcareApixioFile4] ADD CONSTRAINT [PK_WellcareApixioFile4] PRIMARY KEY CLUSTERED  ([WellcareApixioFileID]) ON [PRIMARY]
GO
