...
GO
ALTER TABLE [dbo].[tblCodedData] ADD CONSTRAINT [PK_tblCodedData] PRIMARY KEY CLUSTERED  ([CodedData_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_CodeData_PK] ON [dbo].[tblCodedData] ([CodedData_PK]) INCLUDE ([DiagnosisCode], [DOS_Thru]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblCodedDataSource] ON [dbo].[tblCodedData] ([CodedSource_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblCodedDataICD9] ON [dbo].[tblCodedData] ([DiagnosisCode]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idxtblCodedData_OtherProvider_PK] ON [dbo].[tblCodedData] ([OtherProvider_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblCodedDataProvider] ON [dbo].[tblCodedData] ([Provider_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblCodedDataSuspect] ON [dbo].[tblCodedData] ([Suspect_PK]) ON [PRIMARY]
GO
