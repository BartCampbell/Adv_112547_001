...
BEGIN
	...
	SELECT PO.ProviderOffice_PK,COUNT(DISTINCT S.Provider_PK) Providers, Sum(CASE WHEN IsScanned=0 AND IsCNA=0 THEN 1 ELSE 0 END) Charts,MAX(dtLastContact) LastContact,MAX(follow_up) FollowUpDate,Count(DISTINCT S.Project_PK) Offices 
